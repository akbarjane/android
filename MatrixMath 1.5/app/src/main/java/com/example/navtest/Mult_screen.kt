...
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a11
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a12
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a13
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a21
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a22
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a23
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a31
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a32
import kotlinx.android.synthetic.main.activity_mult_screen.a_mA_a33
import kotlinx.android.synthetic.main.activity_mult_screen.btn_mult
import kotlinx.android.synthetic.main.activity_mult_screen.mult_title
import kotlinx.android.synthetic.main.activity_sum__screen.*

class Mult_screen : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mult_screen)

        mult_back.setOnClickListener {
            ...
            try {
                ...
                for (l in A.indices) {
                    for (j in B[0].indices) {
                        for (k in B.indices) {
                            result[l][j] += ((A[l][k]).toInt() * (B[k][j]).toInt())
                        }
                    }
                }
                ...
                mult_title.setText("Ответ равен :").toString()
            }
            catch (e: Exception){
                ...
                mult_title.setText("Пожалуйста введите все переменные !").toString()
            }
        }
    }
...
//    fun ariph_back(view: View){
//        val screen = Intent(this, ariph_screen::class.java)
