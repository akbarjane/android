...
////
    ...
    fun reverse(v: View) {
        ...
        d_a_g8.text = "Сложим все выражения :\n" +
            ...
            answ_x3.textSize = 0F
            answ_m2.text =
                "4) Умножаем результат транспорации на 4-й столбик и определитель в степени -1"
            m1_1.text = "  1)A*(-2) = "; m1_2.textSize = 14F;m1_4.textSize = 14F

            m1_3.text = "$m5  $m6 \n $m8  $m9"; m1_5.text = " = ${(m5 * m9) - (m6 * m8)}"


            m2_1.text = "  2)A*(-3) = "; m2_2.textSize = 14F;m2_4.textSize = 14F

            m2_3.text = "$m4  $m6 \n $m7  $m9"; m2_5.text = " = ${((m4 * m9) - (m6 * m7)) * -1}"


            m3_1.text = "  3)A*(-4) = "; m3_2.textSize = 14F;m3_4.textSize = 14F

            m3_3.text = "$m4  $m5 \n $m7  $m8"; m3_5.text = " = ${(m4 * m8) - (m5 * m7)}"


            m4_1.text = "  4)A*(-3) = "; m4_2.textSize = 14F;m4_4.textSize = 14F

            m4_3.text = "$m2  $m3 \n $m8  $m9"; m4_5.text = " = ${((m2 * m9) - (m3 * m8)) * -1}"


            m5_1.text = "  5)A*(-4) = "; m5_2.textSize = 14F;m5_4.textSize = 14F

            m5_3.text = "$m1  $m3 \n $m7  $m9"; m5_5.text = " = ${(m1 * m9) - (m7 * m3)}"


            m6_1.text = "  6)A*(-5) = "; m6_2.textSize = 14F;m6_4.textSize = 14F

            m6_3.text = "$m1  $m2 \n $m7  $m8"; m6_5.text = " = ${((m1 * m8) - (m7 * m2)) * -1}"


            m7_1.text = "  7)A*(-4) = "; m7_2.textSize = 14F;m7_4.textSize = 14F

            m7_3.text = "$m2  $m3 \n $m5  $m6"; m7_5.text = " = ${(m2 * m6) - (m5 * m3)}"


            m8_1.text = "  8)A*(-5) = "; m8_2.textSize = 14F;m8_4.textSize = 14F

            m8_3.text = "$m1  $m3 \n $m4  $m6"; m8_5.text = " = ${((m1 * m6) - (m4 * m3)) * -1}"


            m9_1.text = "  9)A*(-6) = "; m9_2.textSize = 14F;m9_4.textSize = 14F
